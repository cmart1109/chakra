    ...
    <>
      ...
      >
        ...
        justify="space-between">
          ...
          <Button marginLeft="10px" border="1px" borderColor="white" p="10px" height="50px" variant="ghost" color="white"_hover={{ color: 'black', backgroundColor: 'white' }}>VER TERRENO</Button>
        </Box>
        </Box>
        </Flex>
    </>
